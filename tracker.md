...
- 指定 Aria2 配置文件路径，比如配置文件在`/home/lighthouse/.aria2/aria2.conf`：
```
bash <(curl -fsSL git.io/tracker.sh) "/home/lighthouse/.aria2/aria2.conf"
```
...
```
bash <(curl -fsSL git.io/tracker.sh) "/home/lighthouse/.aria2/aria2.conf" RPC
```
